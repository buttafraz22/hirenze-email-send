              ...
              <tbody>
                <tr>
                  <td width="300" align="left" valign="top" style="
                    ...
                    ">
                    <img src="https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg" alt="MLSA" class="m_30972499125270521logo m_30972499125270521no-arrow CToWUd" width="75%" height="50%" data-bit="iit">
                  </td>
                  <p style="
                                      padding: 5px;
                                      margin: 5px;
              ...
              <tbody>
                <tr>
                  <td style="
                    ...
                    <div id="m_30972499125270521textContent25f253c04-e2ce-4bd4-81e1-dd82e05bce0c">
                      <div>
                        Looking forward to seeing you further programs,<br>
